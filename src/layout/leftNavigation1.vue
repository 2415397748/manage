<template>
	...
	>
		<el-menu
			><img src="@/img/logo.png" style="font-size: 1.25rem"
		/></el-menu>
		<!-- default-openeds默认展开 -->
		<el-menu
			...
			ref="routes"
		>
			<el-menu-item index="/index/dataCollect"
				><i class="el-icon-pie-chart"></i>数据汇总</el-menu-item
			>
			<el-menu-item index="/index/rightControl"
				><i class="el-icon-setting"></i>权限管理</el-menu-item
			>
			<el-menu-item index="/index/userControl"
				><i class="el-icon-user-solid"></i>用户管理</el-menu-item
			>
			<el-menu-item index="/index/quickMark"
				><i class="el-icon-full-screen"></i>二维码</el-menu-item
			>
			<el-submenu index="商品管理">
				...
				<el-menu-item-group>
					...
					>
					<el-menu-item index="/index/classifyControl"
						><i class="el-icon-menu"></i>分类管理</el-menu-item
					>
				</el-menu-item-group>
			</el-submenu>
			<el-menu-item index="/index/orderControl"
				><i class="el-icon-s-order"></i>订单管理</el-menu-item
			>
			<el-menu-item index="/index/post"
				><i class="el-icon-upload"></i>post请求</el-menu-item
			>
		</el-menu>
	</el-aside>
</template>
