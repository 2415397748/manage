	...
	<el-main>
		...
		<el-table :data="tableData" style="width: 100%" border max-height="500">
			...
			<el-table-column label="操作" fixed="right" min-width="200px">
				<template slot-scope="label">
					<el-button size="mini" @click="handleEdit(label.$index, label.row)" v-loading="loading">编辑</el-button>
					<el-button size="mini" type="danger" @click="handleDelete(label.$index, label.row)">
						删除</el-button>
				</template>
				<el-button size="mini" type="primary" icon="el-icon-location"></el-button>
			</el-table-column>
			
			
		</el-table>
		<el-drawer title="信息编辑 !" :before-close="handleClose" :visible.sync="dialog" direction="rtl"
			...
			<div class="demo-drawer__content">
				<el-form :model="from">
				  ...
				  <el-form-item label="在线状态" :label-width="formLabelWidth">
						<el-switch style="display: block" v-model="from.state" active-color="#13ce66"	inactive-color="#ff4949">
						</el-switch>
				  </el-form-item>
				  <el-form-item label="电话" :label-width="formLabelWidth">
				    <el-input v-model="from.phone"></el-input>
				  </el-form-item> -->
				  <el-form-item :label="tables[i]" :label-width="formLabelWidth" v-for="(item, index,i) in from" v-if=" index !='state' && index !='date' && index !='id'">
