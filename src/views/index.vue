<template>
	<div class="home">
		...
		<el-container style="height: 100%; border: 1px solid #eee">
			<!-- 左侧导航栏 -->
			<component :is="head.value" :key="head.value"></component>

			<el-container>
				<!-- 上方导航栏 -->
				<el-header class="toubu" style="background-color: #b3c0d1">
					<head-navigation :headProp.sync="head" @selects="skip">
					</head-navigation>
				</el-header>
				<!-- 页面主要内容 -->
